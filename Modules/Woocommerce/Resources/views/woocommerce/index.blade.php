...
<section class="content">
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            ...
            <div class="box box-solid">
                <div class="box-header">
                    <h3 class="box-title">Sync product from WooCommerce:</h3>
                </div>
                <div class="box-body">
                    <div class="col-sm-12">
                        <div class="form-group">
                            <label for="dropdown1">Business Location:</label>
                    ...
                    <div class="col-sm-12">
                        <button type="button" class="btn btn-primary btn-block" id="sync_product_button">
...
{{-- <form action="/sync-products-all" method="get">
    <button type="submit" class="btn btn-xs btn-success">Product Sync Now</button>
</form> --}}
<a href="http://127.0.0.1:8000/productsync">
...
//
                $.ajax({
                        url: '{{ route("woocommerce.drop-down-of-business-location") }}', // Replace with the actual URL
                        method: 'GET',
                        dataType: 'json',
                        success: function(response) {
                            ...
                            if (response.success) {
                                ...
                                $.each(response.businessLocations, function(index, location) {
                                    dropdown1.append($('<option>', {
                                        value: location.id,
                                        text: location.location_id // Adjust the property according to your data
                                    }));
                                });
                            } else {
                                // Handle error case
...
//new code
$('#sync_product_button').click(function() {
        var selectedLocationId = $('#dropdown1').val(); // Get the selected value from the dropdown
        // debugger;
        $(window).bind('beforeunload', function(){
            return true;
        });
        ...
        $(this).attr('disabled', true);
         ...
         $.ajax({
            ...
            url: 'http://127.0.0.1:8000/productsync' + '/' + selectedLocationId,
            type:'GET',
            dataType: "json",
            timeout: 0,
            success: function(result) {
                ...
                $('#sync_product_button').html(btn_html);
                $('#sync_product_button').removeAttr('disabled');
                $(window).unbind('beforeunload');
            }
        });
    }); 
