...
class Transaction extends Model
{
    ...
    {
        return $this->hasOne('App\PathaoOrder');
    }
    ...
    public function billing_address($array = false)
    {
        ...
        if (!empty($addresses['billing_address'])) {
            ...
            if (!empty($addresses['billing_address']['billing_city'])) {
                $billingCityPathaoId = $addresses['billing_address']['billing_city'];
                $pathaoCity = City::where('pathao_city_id', $billingCityPathaoId)->first();
                if ($pathaoCity) {
                    $billing_address['city'] = $pathaoCity->name;
                }
